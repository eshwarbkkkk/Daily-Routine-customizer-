...
export default function Footer() {
  return (
    <>
      <footer class="text-gray-400 bg-gray-800 body-font pl-10 pr-10">
        <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <Link class="flex title-font font-medium items-center md:justify-start justify-center text-white">
              ...
              <span class="ml-3 text-xl">Healme</span>
            </Link>
            <p class="mt-2 text-sm text-gray-500">
              A project for better mental health
            </p>
          </div>
          <div class="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first pl-20">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <Link class="text-gray-400 hover:text-white">Concept</Link>
                </li>
                <li>
                  <Link class="text-gray-400 hover:text-white">About us</Link>
                </li>
                <li>
                  <Link class="text-gray-400 hover:text-white">Community</Link>
                </li>
              </nav>
            </div>
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <Link class="text-gray-400 hover:text-white">Chat bot</Link>
                </li>
                <li>
                  <Link class="text-gray-400 hover:text-white">
                    Breathing exercise
                  </Link>
                </li>
              </nav>
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <Link class="text-gray-400 hover:text-white">Donations</Link>
                </li>
                <li>
                  <Link class="text-gray-400 hover:text-white">Community</Link>
                </li>
